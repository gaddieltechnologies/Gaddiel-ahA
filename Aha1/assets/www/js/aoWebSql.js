...
var status ;
						...
						for (var i = 0, item = null; i < dataset.length; i++) 
						{
			               ...
			               // alert("step8: hit for loop");					
							...
							$.ajax(
							{
								...
								data: {ActiveId:activeId,OrgId:orgId,Assign:assign,Resouce:resouce,StartDateTime:startDateTime,StopDateTime:stopDateTime,Status:status,Times:times,Latitude:latitude,Longitude:longitude,Address:address}, 
					...
					tx.executeSql(selectAllStatement, [], function (tx, result)
					{
						...
						if(result.rows.length == 0)
						{
							...
							$.ajax(
							{
								type: "POST",
								url: setURl,//you can get this values from php using $_POST['n1'], $_POST['n2'] and $_POST['add']
								data: {ActiveId:activeId,OrgId:orgId,Assign:assign,Resouce:resouce,StartDateTime:datetime,StopDateTime:stopDateTime,Status:status,Times:times,Latitude:latitude,Longitude:longitude,Address:address}, 
								success: function(data)
								{
	...
	function activateTrackStop() //Function for when press the start button...
	{   
					...
					tx.executeSql(selectAllStatement, [], function (tx, result)
					{
						...
						if(result.rows.length == 0)
						{
							...
							$.ajax(
							{
								type: "POST",
								url: setURl,//you can get this values from php using $_POST['n1'], $_POST['n2'] and $_POST['add']
								data: {ActiveId:activeId,OrgId:orgId,Assign:assign,Resouce:resouce,StartDateTime:startDateTime,StopDateTime:datetime,Status:status,Times:times,Latitude:latitude,Longitude:longitude,Address:address}, 
								success: function(data)
								{
									//alert(data);
